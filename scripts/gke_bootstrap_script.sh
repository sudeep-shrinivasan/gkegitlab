...
PROJECT=${PROJECT-mysandbox1}
REGION=${REGION-us-central1}
ZONE_EXTENSION=${ZONE_EXTENSION-b}
ZONE=${REGION}-${ZONE_EXTENSION}
CLUSTER_NAME=${CLUSTER_NAME-hwjavacluster}
#MACHINE_TYPE=${MACHINE_TYPE-n1-standard-4}
MACHINE_TYPE=${MACHINE_TYPE-g1-small}
...
function bootstrap(){
  ...
  #found the fix from https://github.com/helm/helm/issues/6359#issuecomment-554765526
